...
get_ipython().set_next_input('Mutable or immutable');get_ipython().run_line_magic('pinfo', 'immutable')

get_ipython().set_next_input('The following function adds a mapping between a string and the lowercase version of that string to a dictionary. What do you expect the values of d and s to be after the function is called');get_ipython().run_line_magic('pinfo', 'called')
